...
@interface comAppDelegate : UIResponder <UIApplicationDelegate, UITabBarControllerDelegate, NSXMLParserDelegate, comPlayerDelegate, AVAudioSessionDelegate>{
...
@property (readwrite) long radioList;
